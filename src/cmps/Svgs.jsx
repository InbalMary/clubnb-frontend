export const appHeaderSvg = {
    ...
    >
        <g fill="none">
            <path d="M4 4v24h24" />
            <polyline points="6 22 12 14 18 18 26 10" />
        </g>
    </svg>,
...
export const amenitiesSvg = {
    rate: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", height: "8px", width: "8px" }}><path fillRule="evenodd" d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z"></path>
    </svg>,
    bigRate: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "20px", width: "20px" }}><path fillRule="evenodd" d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z"></path>
    </svg>,
    x: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", height: "26px", width: "26px" }}>
        <g transform="translate(9.75, 9.75)">
            <path d="M12.5 1.5L1.5 12.5" stroke="#222222" stroke-width="2" stroke-miterlimit="12" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M1.5 1.5L12.5 12.5" stroke="#222222" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
        </g>
    </svg >,

    essentials: {

        wifi: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M16 20.33a3.67 3.67 0 1 1 0 7.34 3.67 3.67 0 0 1 0-7.34zm0 2a1.67 1.67 0 1 0 0 3.34 1.67 1.67 0 0 0 0-3.34zM16 15a9 9 0 0 1 8.04 4.96l-1.51 1.51a7 7 0 0 0-13.06 0l-1.51-1.51A9 9 0 0 1 16 15zm0-5.33c4.98 0 9.37 2.54 11.94 6.4l-1.45 1.44a12.33 12.33 0 0 0-20.98 0l-1.45-1.45A14.32 14.32 0 0 1 16 9.66zm0-5.34c6.45 0 12.18 3.1 15.76 7.9l-1.43 1.44a17.64 17.64 0 0 0-28.66 0L.24 12.24c3.58-4.8 9.3-7.9 15.76-7.9z"></path>
        </svg>,
        tv: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        airCon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M17 1v4.03l4.03-2.32 1 1.73L17 7.34v6.93l6-3.47V5h2v4.65l3.49-2.02 1 1.74L26 11.38l4.03 2.33-1 1.73-5.03-2.9L18 16l6 3.46 5.03-2.9 1 1.73L26 20.62l3.49 2.01-1 1.74L25 22.35V27h-2v-5.8l-6-3.47v6.93l5.03 2.9-1 1.73L17 26.97V31h-2v-4.03l-4.03 2.32-1-1.73 5.03-2.9v-6.93L9 21.2V27H7v-4.65l-3.49 2.02-1-1.74L6 20.62l-4.03-2.33 1-1.73L8 19.46 14 16l-6-3.46-5.03 2.9-1-1.73L6 11.38 2.51 9.37l1-1.74L7 9.65V5h2v5.8l6 3.47V7.34l-5.03-2.9 1-1.73L15 5.03V1z"></path>
        </svg>,
        workSpace: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    bathroom: {
        ...
        hairDryer: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        essentials: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        bathTub: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        shampoo: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        conditioner: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M20 1v2h-3v2h1a2 2 0 0 1 2 1.85V9a4 4 0 0 1 4 3.8V27a4 4 0 0 1-3.8 4H12a4 4 0 0 1-4-3.8V13a4 4 0 0 1 3.8-4h.2V7a2 2 0 0 1 1.85-2H15V3H8V1zm2 21H10v5a2 2 0 0 0 1.85 2H20a2 2 0 0 0 2-1.85V27zm0-6H10v4h12zm-2-5h-8a2 2 0 0 0-2 1.85V14h12v-1a2 2 0 0 0-2-2zm-2-4h-4v2h4z"></path>
        </svg>,
        bodySoap: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        hotWater: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        washer: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    bedroom: {
        doubleBed: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        hangers: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        extraPillows: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        roomShades: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        iron: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M12 28a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm4 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm4 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-6-3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm4 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM16.03 3h.3a12.5 12.5 0 0 1 11.82 9.48l.07.3 1.73 7.79.03.14A2 2 0 0 1 28.15 23H2.1a2 2 0 0 1-1.85-1.84v-7.38a5 5 0 0 1 4.77-4.77L5.25 9h9V5h-14V3zm11.53 16H2.25v2H28zM16.24 5v6H5.07a3 3 0 0 0-2.82 2.82V17H27.1l-.84-3.78-.07-.28a10.5 10.5 0 0 0-9.6-7.92L16.32 5z"></path>
        </svg>,
        closet: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    family: {
        ...
        crib: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        boardGames: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    safety: {
        ...
        smokeAlarm: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        firstAid: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        fireExtinguisher: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        securityCam: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    kitchen: {
        ...
        fridge: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        microwave: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        kitchen: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, width: "24px" }}>
        ...
        cookingBasics: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M26 1a5 5 0 0 1 5 5c0 6.39-1.6 13.19-4 14.7V31h-2V20.7c-2.36-1.48-3.94-8.07-4-14.36v-.56A5 5 0 0 1 26 1zm-9 0v18.12c2.32.55 4 3 4 5.88 0 3.27-2.18 6-5 6s-5-2.73-5-6c0-2.87 1.68-5.33 4-5.88V1zM2 1h1c4.47 0 6.93 6.37 7 18.5V21H4v10H2zm14 20c-1.6 0-3 1.75-3 4s1.4 4 3 4 3-1.75 3-4-1.4-4-3-4zM4 3.24V19h4l-.02-.96-.03-.95C7.67 9.16 6.24 4.62 4.22 3.36L4.1 3.3zm19 2.58v.49c.05 4.32 1.03 9.13 2 11.39V3.17a3 3 0 0 0-2 2.65zm4-2.65V17.7c.99-2.31 2-7.3 2-11.7a3 3 0 0 0-2-2.83z"></path>
        </svg>,
        dishes: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M29 1v2a13 13 0 0 0-.3 26h.3v2a15 15 0 0 1-.31-30zM3 1h2v6h2V1h2v6h2V1h2v9a5 5 0 0 1-4 4.9V31H7V14.9a5.01 5.01 0 0 1-3.98-4.44L3 10.22V10zm26 6v2a7 7 0 0 0-.24 14H29v2a9 9 0 0 1-.27-18zM11 9H5v1.15a3 3 0 0 0 6 .03V10z"></path>    </svg>,
        freezer: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M25 1a2 2 0 0 1 2 1.85V29a2 2 0 0 1-1.85 2H7a2 2 0 0 1-2-1.85V3a2 2 0 0 1 1.85-2H7zm0 10H7v18h18zm-15 2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM25 3H7v6h18zM10 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
        </svg>,
        dishwasher: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        inductionStove: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        oven: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M28 2a2 2 0 0 1 2 1.85V28a2 2 0 0 1-1.85 2H4a2 2 0 0 1-2-1.85V4a2 2 0 0 1 1.85-2H4zm0 10H4v16h24zm-2 2v12H6V14zm-2 2H8v8h16zm4-12H4v6h24zm-3 2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-6 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-6 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM7 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>    </svg>,
        kettle: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        coffeeMaker: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        wineGlass: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        toaster: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        table: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
            <path d="M31 9v21h-2v-7h-6v7h-2v-7a2 2 0 0 1 1.85-2H29V9h2zM3 9v12h6a2 2 0 0 1 2 1.85V30H9v-7H3v7H1V9h2zm14-2v2.08a6 6 0 0 1 5 5.7V15h5v2H17v13h-2V17H5v-2h5a6 6 0 0 1 5-5.92V7h2zm-1 4a4 4 0 0 0-4 3.8v.2h8a4 4 0 0 0-4-4z"></path>    </svg>,
    },

    location: {
        pool: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        mountainView: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        center: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    features: {
        ...
        gym: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        breakfast: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        grill: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    bookingOptions: {
        ...
        petsAllowed: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        instantBook: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        selfCheckin: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    outdoor: {
        ...
        sunLoungers: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        privatePatio: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        outdoorDining: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        beachEssentials: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    parking: {
        ...
        freeParking: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        elevator: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    services: {
        ...
        longStay: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        lockBox: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        houseKeeping: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        smokingAllowed: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
    ...
    notIncluded: {
        ...
        noWasher: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        noCarbonMonoxideAlarm: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        noEssentials: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
        ...
        noDryer: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block", height: "24px", width: "24px" }}>
...
export const svgControls = {
    heart: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" >
        <path d="m15.9998 28.6668c7.1667-4.8847 14.3334-10.8844 14.3334-18.1088 0-1.84951-.6993-3.69794-2.0988-5.10877-1.3996-1.4098-3.2332-2.11573-5.0679-2.11573-1.8336 0-3.6683.70593-5.0668 2.11573l-2.0999 2.11677-2.0988-2.11677c-1.3995-1.4098-3.2332-2.11573-5.06783-2.11573-1.83364 0-3.66831.70593-5.06683 2.11573-1.39955 1.41083-2.09984 3.25926-2.09984 5.10877 0 7.2244 7.16667 13.2241 14.3333 18.1088z"></path>
    </svg>,
    chevronLeft: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" >
        <path fill="none" d="M20 28 8.7 16.7a1 1 0 0 1 0-1.4L20 4"></path>
    </svg>,
    chevronRight: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" >
        <path fill="none" d="m12 4 11.3 11.3a1 1 0 0 1 0 1.4L12 28"></path>
    </svg>,
    closeModal: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false">
        <path d="m6 6 20 20M26 6 6 26"></path>
    </svg>,
    backArrow: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: 4, overflow: 'visible' }}>
        <g fill="none"><path d="M4 16h26M15 28 3.7 16.7a1 1 0 0 1 0-1.4L15 4"></path></g>
    </svg>,
    backArrow1: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', fill: 'none', stroke: 'currentcolor', overflow: 'visible' }}>
        <g fill="none"><path d="M4 16h26M15 28 3.7 16.7a1 1 0 0 1 0-1.4L15 4"></path></g>
    </svg>,
    chevronDown: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ stroke: "#222222", strokeWidth: 4, display: "block", height: "16px", width: "16px" }}>
    ...
    share: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ stroke: "#222222", strokeWidth: 2.5, display: "block" }}>
    ...
    house: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false">
    ...
    list: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" role="presentation" focusable="false"
        style={{
            display: "block",
            height: "1rem",
            width: "1rem",
    ...
    map: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false"
        style={{
            display: "block",
            height: "1rem",
            width: "1rem",
...
export const reviewSvgs = {
    location: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block" }}>
        <path d="M30.95 3.81a2 2 0 0 0-2.38-1.52l-7.58 1.69-10-2-8.42 1.87A1.99 1.99 0 0 0 1 5.8v21.95a1.96 1.96 0 0 0 .05.44 2 2 0 0 0 2.38 1.52l7.58-1.69 10 2 8.42-1.87A1.99 1.99 0 0 0 31 26.2V4.25a1.99 1.99 0 0 0-.05-.44zM12 4.22l8 1.6v21.96l-8-1.6zM3 27.75V5.8l-.22-.97.22.97 7-1.55V26.2zm26-1.55-7 1.55V5.8l7-1.55z"></path>
    </svg>,
    accuracy: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block" }}>
    ...
    value: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block" }}>
    ...
    checkIn: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block" }}>
        <path d="M16.84 27.16v-3.4l-.26.09c-.98.32-2.03.51-3.11.55h-.7A11.34 11.34 0 0 1 1.72 13.36v-.59A11.34 11.34 0 0 1 12.77 1.72h.59c6.03.16 10.89 5.02 11.04 11.05V13.45a11.3 11.3 0 0 1-.9 4.04l-.13.3 7.91 7.9v5.6H25.7l-4.13-4.13zM10.31 7.22a3.1 3.1 0 1 1 0 6.19 3.1 3.1 0 0 1 0-6.2zm0 2.06a1.03 1.03 0 1 0 0 2.06 1.03 1.03 0 0 0 0-2.06zM22.43 25.1l4.12 4.13h2.67v-2.67l-8.37-8.37.37-.68.16-.3c.56-1.15.9-2.42.96-3.77v-.64a9.28 9.28 0 0 0-9-9h-.55a9.28 9.28 0 0 0-9 9v.54a9.28 9.28 0 0 0 13.3 8.1l.3-.16 1.52-.8v4.62z"></path>
    </svg>,
    cleanliness: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#222222", stroke: "#fefafaff", strokeWidth: .01, display: "block" }}>
        <path d="M24 0v6h-4.3c.13 1.4.67 2.72 1.52 3.78l.2.22-1.5 1.33a9.05 9.05 0 0 1-2.2-5.08c-.83.38-1.32 1.14-1.38 2.2v4.46l4.14 4.02a5 5 0 0 1 1.5 3.09l.01.25.01.25v8.63a3 3 0 0 1-2.64 2.98l-.18.01-.21.01-12-.13A3 3 0 0 1 4 29.2L4 29.02v-8.3a5 5 0 0 1 1.38-3.45l.19-.18L10 12.9V8.85l-4.01-3.4.02-.7A5 5 0 0 1 10.78 0H11zm-5.03 25.69a8.98 8.98 0 0 1-6.13-2.41l-.23-.23A6.97 6.97 0 0 0 6 21.2v7.82c0 .51.38.93.87 1H7l11.96.13h.13a1 1 0 0 0 .91-.88l.01-.12v-3.52c-.34.04-.69.06-1.03.06zM17.67 2H11a3 3 0 0 0-2.92 2.3l-.04.18-.01.08 3.67 3.1h2.72l.02-.1a4.29 4.29 0 0 1 3.23-3.4zM30 4a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-3-2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-5 0h-2.33v2H22zm8-2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM20 20.52a3 3 0 0 0-.77-2l-.14-.15-4.76-4.61v-4.1H12v4.1l-5.06 4.78a3 3 0 0 0-.45.53 9.03 9.03 0 0 1 7.3 2.34l.23.23A6.98 6.98 0 0 0 20 23.6z"></path>    </svg>,
    communication: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ fill: "#eee2e2ff", stroke: "#464545ff", strokeWidth: .1, display: "block" }}>
        <path d="m25.5 3.5c2.2091 0 4 1.79086 4 4v13.8333c0 2.2092-1.7909 4-4 4h-5.8192l-3.6808 4.5-3.6832-4.5h-5.8168c-2.20914 0-4-1.7908-4-4v-13.8333c0-2.20914 1.79086-4 4-4z" fill="none"
            stroke="#222222"
            strokeWidth="2"></path>
    </svg>,
...
export const hostSvgs = {
    born: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}><path d="M16 0c5.9 0 11 5.28 11 11 0 4.85-3.23 9.27-9.55 13.28l2.2 2.92a1.13 1.13 0 0 1-.9 1.8H17v3h-2v-3h-1.75a1.13 1.13 0 0 1-.9-1.8l2.14-2.86C8.2 20.92 5 16.46 5 11A11 11 0 0 1 16 0zm0 25.67L15 27h2zM16 2a9 9 0 0 0-9 9c0 4.6 2.72 8.43 8.3 11.5l.38.21.28.14.3-.19c5.62-3.53 8.48-7.24 8.72-11.12l.02-.27V11c0-4.64-4.21-9-9-9z"></path>
    </svg>,
    work: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}><path d="M20 2a2 2 0 0 1 2 1.85V6h6a3 3 0 0 1 3 2.82V27a3 3 0 0 1-2.82 3H4a3 3 0 0 1-3-2.82V9a3 3 0 0 1 2.82-3H10V4a2 2 0 0 1 1.85-2H12zm8 6H4a1 1 0 0 0-1 .88V12a3 3 0 0 0 2.82 3H13v2H6a4.98 4.98 0 0 1-3-1v11a1 1 0 0 0 .88 1H28a1 1 0 0 0 1-.88V16c-.78.59-1.74.95-2.78 1h-7.17v-2H26a3 3 0 0 0 3-2.82V9a1 1 0 0 0-.88-1zm-10 4a1 1 0 0 1 1 .88V19a1 1 0 0 1-.88 1H14a1 1 0 0 1-1-.88V13a1 1 0 0 1 .88-1H14zm-1 2h-2v4h2zm3-10h-8v2h8z"></path>
    </svg>,
    school: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcol' }}><path d="m31.47 10.12-15-8a1 1 0 0 0-.94 0l-15 8a1 1 0 0 0 0 1.76L4 13.73V23a1 1 0 0 0 .52.88l11 6a1 1 0 0 0 .96 0l11-6A1 1 0 0 0 28 23v-9.27l2-1.06V23h2V11a1 1 0 0 0-.53-.88zM26 22.4l-10 5.45-10-5.45V14.8l9.53 5.08a1 1 0 0 0 .94 0L26 14.8v7.6zm-10-4.54L3.12 11 16 4.13 28.88 11 16 17.87z"></path>
    </svg>,
    music: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}><path d="m28 2.12-.22.01-16 1.78A2 2 0 0 0 10 5.89v15.14A4.95 4.95 0 0 0 7 20a5 5 0 1 0 5 5V11.9l16-1.78v8.9A4.95 4.95 0 0 0 25 18a5 5 0 1 0 5 5V4.12a2 2 0 0 0-2-2zM7 28a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm5-18.12V5.9l16-1.77V8.1L12 9.88zM25 26a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"></path>
    </svg>,
    languages: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}><path d="M26 2a5 5 0 0 1 5 4.78V21a5 5 0 0 1-4.78 5h-6.06L16 31.08 11.84 26H6a5 5 0 0 1-4.98-4.56L1 21.22 1 21V7a5 5 0 0 1 4.78-5H26zm0 2H6a3 3 0 0 0-3 2.82V21a3 3 0 0 0 2.82 3H12.8l3.2 3.92L19.2 24H26a3 3 0 0 0 3-2.82V7a3 3 0 0 0-2.82-3H26zM16 6a8.02 8.02 0 0 1 8 8.03A8 8 0 0 1 16.23 22h-.25A8 8 0 0 1 8 14.24v-.25A8 8 0 0 1 16 6zm1.68 9h-3.37c.11 1.45.43 2.76.79 3.68l.09.22.13.3c.23.45.45.74.62.8H16c.33 0 .85-.94 1.23-2.34l.11-.44c.16-.67.29-1.42.34-2.22zm4.24 0h-2.23c-.1 1.6-.42 3.12-.92 4.32a6 6 0 0 0 3.1-4.07l.05-.25zm-9.61 0h-2.23a6 6 0 0 0 3.14 4.32c-.5-1.2-.82-2.71-.91-4.32zm.92-6.32-.13.07A6 6 0 0 0 10.08 13h2.23c.1-1.61.42-3.12.91-4.32zM16 8h-.05c-.27.08-.64.7-.97 1.65l-.13.4a13.99 13.99 0 0 0-.54 2.95h3.37c-.19-2.66-1.1-4.85-1.63-5H16zm2.78.69.02.05c.48 1.19.8 2.68.9 4.26h2.21A6.02 6.02 0 0 0 19 8.8l-.22-.12z"></path>
    </svg>

}

export const statSvgs = {
    star: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: "block", height: "14px", width: "14px" }}><path fillRule="evenodd" d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z"></path>
    </svg>,
    starSmall: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: "block", height: "12px", width: "12px" }}><path fillRule="evenodd" d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z"></path>
    </svg>,
    starXSmall: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: "block", height: "8px", width: "8px" }}><path fillRule="evenodd" d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z"></path>
    </svg>,

}

export const badgesSvgs = {
    guestFavorite: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
        aria-hidden="true" role="presentation" focusable="false">
    ...
    rareFind: <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true" role="presentation" focusable="false"
        style={{ display: 'block', height: '40px', width: '40px', fill: 'rgb(227, 28, 95)' }} stroke="currentcolor"><g stroke="none">
            <path d="m32.62 6 9.526 11.114-18.146 23.921-18.147-23.921 9.526-11.114z" fillOpacity=".2">
            </path>
...
export const logoSvgs = {
    ...
    whatsapp: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", height: "24px", width: "24px" }}>
    ...
    moreOptions: <svg width="40px" height="40px" viewBox="0 0 1.6 1.6" enable-background="new 0 0 32 32" id="Editable-line" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path cx="16" cy="16" fill="none" id="XMLID_878_" r="2" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="0.1" d="M0.9 0.8A0.1 0.1 0 0 1 0.8 0.9A0.1 0.1 0 0 1 0.7 0.8A0.1 0.1 0 0 1 0.9 0.8z" /><path cx="6" cy="16" fill="none" id="XMLID_879_" r="2" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="0.1" d="M0.4 0.8A0.1 0.1 0 0 1 0.3 0.9A0.1 0.1 0 0 1 0.2 0.8A0.1 0.1 0 0 1 0.4 0.8z" /><path cx="26" cy="16" fill="none" id="XMLID_880_" r="2" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="0.1" d="M1.4 0.8A0.1 0.1 0 0 1 1.3 0.9A0.1 0.1 0 0 1 1.2 0.8A0.1 0.1 0 0 1 1.4 0.8z" /></svg>,
    copy: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", height: "24px", width: "24px", }} fill:currentColor><path d="M11.5 3A2.5 2.5 0 0 1 14 5.34v7.16a2.5 2.5 0 0 1-2.34 2.5H6.5A2.5 2.5 0 0 1 4 12.66V5.5A2.5 2.5 0 0 1 6.34 3h5.16zM12 .25v1.5H6a3.25 3.25 0 0 0-3.25 3.07V11h-1.5V5A4.75 4.75 0 0 1 5.78.25H12z"></path></svg>
}